...
{
	return((u8)(flag_bit(card->flags,NET_CARD_ADMIN_UP)+
		flag_bit(card->flags,NET_CARD_LINK_UP)+
		flag_bit(card->flags,NET_CARD_ADDR4)+
		flag_bit(card->flags,NET_CARD_ADDR6)+
		flag_bit(card->flags,NET_CARD_GATEWAY4)+
		flag_bit(card->flags,NET_CARD_GATEWAY6)));
}
